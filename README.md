...
Neural Interview Audiolizer is a ".txt to .wav" notebook that turns textual dialogue (e.g. an interview, a chat) of two individuals to audio dialogue, currently using either [Google Cloud Text-to-Speech API](https://cloud.google.com/text-to-speech) or [Amazon Polly Text-to-Speech API](https://aws.amazon.com/polly/).
